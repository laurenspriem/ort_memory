  ...
  override fun onMethodCall(call: MethodCall, result: Result) {
    when (call.method) {
      ...
      "predict" -> {
        ...
        if (sessionAddress == null || modelType == null || inputUint8DataArray == null) {
          result.error("INVALID_ARGUMENT", "Session address, model type, or input data is missing", null)
          return
        }

        predict(ModelType.valueOf(modelType), sessionAddress, inputUint8DataArray, inputShapeArray, result)
      }
      else -> {
